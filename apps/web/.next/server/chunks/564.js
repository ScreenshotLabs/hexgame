...
exports.Routes = {
  Page404: (query) => ({ pathname: "/404", query }),
  ForgotPasswordPage: (query) => ({ pathname: "/auth/forgot-password", query }),
  LoginPage: (query) => ({ pathname: "/auth/login", query }),
  ResetPasswordPage: (query) => ({ pathname: "/auth/reset-password", query }),
  SignupPage: (query) => ({ pathname: "/auth/signup", query }),
...
module.exports = __webpack_require__(3648)(exports);
...
function setup(env) {
	...
	createDebug.humanize = __webpack_require__(3231);
...
if (typeof process === 'undefined' || process.type === 'renderer' || false === true || process.__nwjs) {
	...
	module.exports = __webpack_require__(5029);
}
...
try {
	...
	const supportsColor = __webpack_require__(2503);
...
var _normalizeTrailingSlash = __webpack_require__(2640);
...
var _hasBasePath = __webpack_require__(4332);
const basePath =  false || "";
...
var _interop_require_default = (__webpack_require__(9838)/* ["default"] */ .Z);
var _getAssetPathFromRoute = _interop_require_default(__webpack_require__(9565));
var _trustedTypes = __webpack_require__(4899);
var _requestIdleCallback = __webpack_require__(3264);
...
var _extends = (__webpack_require__(4990)/* ["default"] */ .Z);
var _interop_require_wildcard = (__webpack_require__(4691)/* ["default"] */ .Z);
var _object_without_properties_loose = (__webpack_require__(6713)/* ["default"] */ .Z);
var _react = _interop_require_wildcard(__webpack_require__(6689));
var _headManagerContext = __webpack_require__(2796);
var _headManager = __webpack_require__(7224);
var _requestIdleCallback = __webpack_require__(3264);
...
exports["default"] = void 0;
var _async_to_generator = (__webpack_require__(7885)/* ["default"] */ .Z);
var _extends = (__webpack_require__(4990)/* ["default"] */ .Z);
var _interop_require_default = (__webpack_require__(9838)/* ["default"] */ .Z);
var _interop_require_wildcard = (__webpack_require__(4691)/* ["default"] */ .Z);
var _normalizeTrailingSlash = __webpack_require__(2640);
var _removeTrailingSlash = __webpack_require__(3297);
var _routeLoader = __webpack_require__(5342);
var _script = __webpack_require__(2553);
var _isError = _interop_require_wildcard(__webpack_require__(6330));
...
var _detectDomainLocale = __webpack_require__(7196);
var _parsePath = __webpack_require__(8854);
var _addLocale = __webpack_require__(3016);
var _removeLocale = __webpack_require__(3602);
var _removeBasePath = __webpack_require__(1820);
var _addBasePath = __webpack_require__(2015);
var _hasBasePath = __webpack_require__(4332);
...
const tty = __webpack_require__(6224);
const hasFlag = __webpack_require__(3031);
...
const reactQuery = __webpack_require__(8910);
...
const _debug = __webpack_require__(8868);
...
function withSuperJSONPage(Page) {
  function WithSuperJSON(serializedProps) {
    return /* @__PURE__ */ React__namespace.createElement(Page, {
      ...deserializeProps(serializedProps)
    });
  }
...
class ErrorBoundary extends React__namespace.Component {
  ...
  async componentDidCatch(error, info) {
    if (error instanceof blitz.RedirectError) {
      ...
      await this.context?.push(error.url);
      return;
    }
  ...
  componentDidMount() {
    ...
    this.context?.events?.on("routeChangeComplete", this.handleRouteChange);
  }
  componentWillUnmount() {
    this.context?.events?.off("routeChangeComplete", this.handleRouteChange);
  }
  ...
  render() {
    ...
    if (error !== null) {
      ...
      if (error instanceof blitz.RedirectError) {
        ...
        return /* @__PURE__ */ React__namespace.createElement(FallbackComponent, {
          ...props
        });
      } else {
        throw new Error(
...
const buildWithBlitz = (plugins) => {
  ...
  return function withBlitzAppRoot(UserAppRoot) {
    const BlitzOuterRoot = (props) => {
      ...
      }, /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, props.Component.suppressFirstRenderFlicker && /* @__PURE__ */ React__default.createElement(NoPageFlicker, null), /* @__PURE__ */ React__default.createElement(UserAppRoot, {
        ...props,
        Component: component
      })));
    };
...
const BlitzProvider = ({
  ...
  if (client) {
    return /* @__PURE__ */ React__default.createElement(RouterContext.Provider, {
      ...
      contextSharing
    }, /* @__PURE__ */ React__default.createElement(reactQuery.Hydrate, {
...
const reactQuery = __webpack_require__(8910);
const indexBrowser = __webpack_require__(1643);
const router = __webpack_require__(7664);
const _blitz = __webpack_require__(4390);
...
const prefetchQueryFactory = (ctx) => {
  ...
  return {
    ...
    prefetchQuery: async (fn, input, defaultOptions = {}, infinite = false) => {
      if (!queryClient) {
        queryClient = new reactQuery.QueryClient({ defaultOptions });
      }
      const queryKey = infinite ? rpc.getInfiniteQueryKey(fn, input) : rpc.getQueryKey(fn, input);
      await queryClient.prefetchQuery(queryKey, () => fn(input, ctx));
    }
  };
};
const setupBlitzServer = ({ plugins, onError }) => {
  const middlewares = plugins.flatMap((p) => p.requestMiddlewares);
  const contextMiddleware = plugins.flatMap((p) => p.contextMiddleware).filter(Boolean);
  const gSSP = (handler) => async ({ req, res, ...rest }) => {
    await blitz.handleRequestWithMiddleware(req, res, middlewares);
  ...
  const gSP = (handler) => async (context) => {
...
function withBlitz(nextConfig = {}) {
  ...
  const { blitz: blitz$1, ...rest } = config;
  return rest;
}
function withDehydratedState(result, queryClient) {
  ...
  return { ...result, props: { ..."props" in result ? result.props : void 0, dehydratedState } };
}
const normalizeRedirectValues = (result) => {
  if ("redirect" in result) {
    const dest = result.redirect?.destination;
    if (dest && blitz.isRouteUrlObject(dest)) {
      const resolvedDest = router.resolveHref({ asPath: "/", pathname: "/" }, dest, true);
      return {
        ...result,
